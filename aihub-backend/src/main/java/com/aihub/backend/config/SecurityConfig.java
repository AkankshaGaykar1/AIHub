    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Categories public read, admin modifications
                ...
                // Tools public read, admin modifications
                .requestMatchers(HttpMethod.GET, "/api/tools/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/search").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/tools/**").hasAuthority("ROLE_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/tools/**").hasAuthority("ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/tools/**").hasAuthority("ROLE_ADMIN")
                
                // Reviews public read, authenticated write
                .requestMatchers(HttpMethod.GET, "/api/reviews/tool/**").permitAll()
